...
export function ToastItem({
  ...
  if (toast.kind === 'custom') {
    return (
      ...
      >
        {toast.customContent ? (
          <div className='t-custom-content'>
            {toast.customContent}
            <button
              className='t-close'
          ...
          <div className='t-row'>
            {toast.customIcon && (
              <div className='t-custom-icon'>{toast.customIcon}</div>
            )}
            <div className='t-col' style={{ flex: 1 }}>
              ...
              {toast.customActions && (
                <div className='t-custom-actions'>{toast.customActions}</div>
              )}
            </div>
            <button
              className='t-close'
